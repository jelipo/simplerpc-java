 ...
 */
class RpcClientFactory(sender: SenderInterface, classList: List<Class<*>>) {
    ...
    fun add(clazz: Class<*>) {
        ...
        if (!clazz.isInterface) {
            throw NotInterfaceException("${clazz.canonicalName} is not an interface.")
        }
